...
<body>
	...
	<div class="container heading1">
		<h1 style="color:white;font-size:50px;font-weight:bold">Find New restaurants near you and order online for free.</h1>
		...
		<div class="col-sm-12" style="padding:40px">
			...
			<form class="form-inline" action="search.php" method="POST">
				<div class="form-group col-xs-8">
					<input type="text" name="location" class="form-control input-lg" id="location" placeholder="Enter location. Eg: Hoboken" style="width:100%">
				</div>
